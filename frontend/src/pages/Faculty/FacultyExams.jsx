...
const FacultyExams = () => {
  ...
  return (
    <div className="space-y-12 pb-20">
      {/* Page Header */}
      <div className="bg-white p-6 md:p-10 rounded-[3.5rem] border border-slate-100 shadow-sm flex flex-col md:flex-row justify-between items-center gap-8 relative overflow-hidden group">
      ...
      <div className="grid grid-cols-1 gap-6">
        {loading ? (
          ...
          filteredScores.map((score) => (
            <div key={score.id} className="bg-white p-6 md:p-10 rounded-[2.8rem] border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-700 group flex flex-col xl:flex-row gap-8 items-start xl:items-center relative overflow-hidden">
